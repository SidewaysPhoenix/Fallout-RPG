...
function renderCapsContainer() {
    ...
    CapsContainer.style.border = '1px solid #ccc';
...
function renderArmorSection(section) {
    ...
    sectionContainer.style.border = '1px solid #ccc';
    ...
    apparelLabel.style.fontSize = '14px'
...
apparelDisplay.style.borderRadius = '5px';
...
async function renderArmorSections() {
    ...
    poisonDRContainer.style.border = '1px solid #ccc';
