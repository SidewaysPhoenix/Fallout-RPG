...
function renderStatsSection() {	
    ...
    derivedTitle.style.marginBottom = "15px";
...
function renderCapsContainer() {
    ...
    CapsContainer.style = "padding:10px;border:3px solid #2e4663;border-radius:8px;background:#325886;display:flex;align-items:center;margin-bottom:10px;width:100%;max-width:200px;gap:15px;justify-self:right;";
