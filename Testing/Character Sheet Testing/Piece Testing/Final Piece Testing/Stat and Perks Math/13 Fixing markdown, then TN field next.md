...
function addWeaponToTable(weapon, tbody, weapons) { 
    ...
    function updateDisplay() {
        ...
        // Preserve all markdown links, even if mixed with plain text
    ...
    td.addEventListener('click', () => {
        ...
        input.type = 'text';
        input.value = weapon[key] || ""; // Show full markdown link while editing
        ...
        input.addEventListener('blur', () => {
            ...
            if (newValue) {
                // Preserve ALL existing markdown links, but auto-wrap plain text
                newValue = newValue.replace(/\[\[|\]\]/g, ''); // Remove existing brackets for proper formatting
