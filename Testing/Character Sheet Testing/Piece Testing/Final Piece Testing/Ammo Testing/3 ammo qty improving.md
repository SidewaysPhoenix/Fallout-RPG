...
function addAmmoToTable(ammo, tbody, ammoList) {
    ...
    ["name", "qty", "description"].forEach((key, index) => {
        ...
        if (key === "qty") {
            ...
            decreaseIcon.style.color = "#efdd6f";
