...
const updateDerivedStats = () => {
    ...
    console.log("Updating Derived Stats:", { END: end, LCK: lck, PER: per, AGI: agi });
    ...
    console.log("Updated Values - Maximum HP:", inputs['Maximum HP']?.value, "Initiative:", inputs['Initiative']?.value);
};
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px; align-items:start;">
                ...
                <div style="border-left: 2px solid rgba(255,255,255,0.2); padding-left:20px; border:1px solid #ccc; padding:15px; border-radius:8px; display:grid; grid-template-columns: 1fr 1fr; gap:10px;">
                    <div>
                        ...
                        <label style="color:#FFC200">Melee Damage:</label> <input id="MeleeDamage" type="number" style="width:100%; background-color:#fde4c9; border-radius:5px; color:black;">
                    ...
                    <div style="display:grid; grid-template-rows: auto auto; gap:5px; align-items:center;">
                        ...
                        <div style="border:1px solid #efdd6f; padding:5px; display:grid; grid-template-columns: auto auto; align-items:center;">
                            ...
                            <label style="color:#FFC200">Maximum HP:</label> <input id="Maximum HP" type="number" style="width:80px; background-color:#fde4c9; border-radius:5px; color:black;">
                            <label style="color:#FFC200">Current HP:</label> <input id="CurrentHP" type="number" style="width:80px; background-color:#fde4c9; border-radius:5px; color:black;">
                        </div>
                    </div>
                </div>
            </div>
