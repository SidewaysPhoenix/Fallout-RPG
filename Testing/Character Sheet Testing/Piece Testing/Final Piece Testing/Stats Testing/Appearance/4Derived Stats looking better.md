    ...
    builder.createParagraph(
        `<div style="display:grid; grid-template-columns: 1fr; gap:20px; width:100%; max-width:800px; background-color:#325886; padding:15px; border-radius:8px;">
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px; align-items:start;">
                ...
                <div style="border-left: 2px solid rgba(255,255,255,0.2); padding-left:20px; border:1px solid #ccc; padding:15px; border-radius:8px;">
                    <div style="font-weight:bold; font-size:22px; color:#efdd6f; text-align:center; padding-bottom:5px;">Derived Stats</div>
                    <div style="display:grid; grid-template-columns: auto 1fr; gap:5px; align-items:center;">
                        <label>Melee Damage:</label> <input id="MeleeDamage" type="number" style="width:80px; background-color:#fde4c9; color:black;">
                        <label>Defense:</label> <input id="Defense" type="number" style="width:80px; background-color:#fde4c9; color:black;">
                        <label>Initiative:</label> <input id="Initiative" type="number" style="width:80px; background-color:#fde4c9; color:black;">
                        <label>Luck Points:</label> <input id="LuckPoints" type="number" style="width:80px; background-color:#fde4c9; color:black;">
                        <div style="display:flex; justify-content:space-between; width:100%;">
                            <div><label>Maximum HP:</label> <input id="MaxHP" type="number" style="width:60px; background-color:#fde4c9; color:black;"></div>
                            <div><label>Current HP:</label> <input id="CurrentHP" type="number" style="width:60px; background-color:#fde4c9; color:black;"></div>
                        </div>
                    </div>
                </div>
            </div>
