        ...
        `<div style="display:grid; grid-template-columns: 1fr; gap:20px; width:100%; max-width:800px; background-color:#325886; padding:15px; border-radius:8px;">
            ...
            <div style="display:grid; grid-template-columns: 1fr 1fr; gap:20px;">
                ...
                <div style="border:1px solid #ccc; padding:15px; border-radius:8px;">
                    ...
                    <label>Level:</label> <input id="Level" type="number" style="width:50px; background-color:#fde4c9; color:black;"><br>
                ...
                <div style="border-left: 2px solid rgba(255,255,255,0.2); padding-left:20px; border:1px solid #ccc; padding:15px; border-radius:8px;">
                    <div style="font-weight:bold; font-size:22px; color:#efdd6f; text-align:center;">Derived Stats</div>
                    <label>Melee Damage:</label> <input id="MeleeDamage" type="number" style="width:80px; background-color:#fde4c9; color:black;"><br>
                    <label>Defense:</label> <input id="Defense" type="number" style="width:80px; background-color:#fde4c9; color:black;"><br>
                    <label>Initiative:</label> <input id="Initiative" type="number" style="width:80px; background-color:#fde4c9; color:black;"><br>
                    <label>Luck Points:</label> <input id="LuckPoints" type="number" style="width:80px; background-color:#fde4c9; color:black;"><br>
