...
melee_bonus: ""
luck_points: ""
phys_dr: "2 (Head, Arms, Torso, Legs)"
energy_dr: "2 (Head, Arms, Torso, Legs)"
rad_dr: "0"
poison_dr: "0"
attacks:
  - name: "`dice: 2d20|render|text(UNARMED STRIKE: STR + Unarmed (TN 8))`"
    desc: "2 D6  Physical damage"
  - name: "`dice: 2d20|render|text(TIRE IRON: STR + Melee Weapons (TN 9))`"
    desc: "4 D6  Physical damage"
  - name: "`dice: 2d20|render|text(Pump-Action Shotgun: AGI + Small Guns (TN 11))`"
    desc: "5 D6  Physical damage, Range C, Fire Rate 2, [[Close Quarters]], [[Unreliable]]"
special_abilities:
  - name: "LET RIP:"
    desc: "Once per combat, the Raider may ‘let rip’ with a volley from their [[Pump-Action Shotgun]]. This adds the weapon’s Fire Rate of 1 to the weapon’s damage for a single attack (for 6 D6  total)."
scavenge_rules:
  - name: ""
    desc: "[[Spike Armor]]\n [[Pump-Action Shotgun]]\n [[Tire Iron]]\n Wealth 2"
```