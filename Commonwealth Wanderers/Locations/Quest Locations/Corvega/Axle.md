...
attacks:
 ...
 - name: "`dice: 2d20|render|text(Tactical Bull Barrel .44 Pistol: AGI + Small Guns (TN 12))`"
   desc: "6 D6  [[Vicious]] Physical damage, Range C, [[Close Quarters]], [[Reliable]]"
special_abilities:
- name: "Cruel (Legendary)"
...
- name: "IN CHARGE:"
  desc: "Axle may spend a minor action to order Sprocket to immediately perform a minor action. Alternatively, Axle may spend a major action to order another raider to take a major action immediately."
scavenge_rules:
 - name: ""
   desc: "[[Heavy Raider Chest Piece]]\n [[Sturdy Raider Leg]] x2\n [[Heavy Raider Arm]] x2\n 3 [[Frag Grenade]]s\n Tactical Bull Barrel [[44 Pistol]] ([[Reflex Sight]]), ([[Bull Barrel]])\n Wealth 2"
```
